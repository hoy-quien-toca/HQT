...
export default function SubmitEvent() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const data = {
      ...
      address: formData.get('address'), // DIRECCION AGREGADA
      ...
      <main className="max-w-3xl mx-auto p-4 md:p-12 relative z-10 font-black">
        {submitted ? (
          <div className="border-8 border-white p-12 bg-zinc-950 shadow-[12px_12px_0px_0px_rgba(220,38,38,0.5)] rounded-[40px] text-center space-y-6 font-black">
            ...
            <p className="text-xl font-bold uppercase tracking-widest italic font-black">Tu fecha está en la cola de aprobación.</p>
            <Link href="/" className="inline-block bg-white text-black px-12 py-4 rounded-full font-black uppercase hover:bg-red-600 hover:text-white transition-all shadow-lg font-black">Volver al Inicio</Link>
          </div>
        ) : (
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left font-black uppercase">
              ...
              <div className="md:col-span-2 grid grid-cols-2 gap-4 font-black">
                ...
                <div className="space-y-2 font-black">
                  ...
                  <input required name="ticket_contact" className="w-full bg-zinc-900 border-4 border-white p-4 rounded-3xl focus:border-red-600 outline-none font-black" />
                </div>
              </div>
              <button disabled={loading || uploading} className="md:col-span-2 w-full bg-red-600 text-white font-black uppercase text-2xl py-5 rounded-full hover:bg-white hover:text-black transition-all border-4 border-white shadow-xl italic tracking-tighter disabled:opacity-50 font-black">
