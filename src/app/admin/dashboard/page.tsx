          ...
          {editingEvent && (
            <div className="border-4 border-blue-600 p-4 bg-zinc-950 space-y-4 rounded-3xl font-black">
              <form onSubmit={handleSaveEvent} className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-white">
                ...
                <input value={editingEvent.ticket_contact || ''} onChange={e => setEditingEvent({...editingEvent, ticket_contact: e.target.value})} className="sm:col-span-2 bg-black border-2 border-white p-2 rounded-lg" placeholder="LINK DE PAGO / ENTRADAS (URL)" />
