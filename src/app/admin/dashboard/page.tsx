                ...
                {event.is_approved && (
                  <div className="space-y-3 border-t border-zinc-800 pt-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <button onClick={() => updateEventTag(event.id, '')} className="text-[7px] font-black uppercase text-zinc-500 underline ml-auto">BORRAR TAG</button>
                    </div>
      ...
      {selectedMessage && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-xl bg-zinc-900 border-8 border-white p-8 shadow-[20px_20px_0px_0px_rgba(234,179,8,1)] text-left">
            <button onClick={() => setSelectedMessage(null)} className="absolute -top-4 -right-4 bg-red-600 text-white w-10 h-10 font-black text-xl border-4 border-white text-center">X</button>
