    ...
    <div className="min-h-screen bg-zinc-900 text-white font-sans relative overflow-x-hidden">
      ...
      <main className="max-w-6xl mx-auto p-6 space-y-12 relative z-10">
        ...
        {featuredEvent && (
          <section className="relative h-[400px] border-8 border-white bg-zinc-800 flex items-end p-8 overflow-hidden shadow-[12px_12px_0px_0px_rgba(234,179,8,1)]">
            ...
            <div className="relative z-20">
              <span className="bg-red-600 text-white px-3 py-1 text-sm font-black uppercase italic tracking-widest shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
                {featuredEvent.suggestion_tag || 'Planazo'}
              </span>
              <h2 className="text-5xl md:text-7xl font-black uppercase italic leading-[0.85] tracking-tighter mt-2">
          ...
          <div className="flex-1 space-y-12">
            ...
            <section className="bg-yellow-400 text-black p-4 flex flex-wrap gap-4 items-center font-black uppercase italic shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
              ...
              <input 
                ...
                className="bg-black text-white p-2 border-2 border-white focus:outline-none placeholder:text-zinc-500 w-32 font-bold"
              />
              <input 
                type="date" 
              ...
              <button 
                onClick={fetchData}
                className="bg-red-600 text-white px-6 py-2 border-2 border-white hover:bg-black transition-colors font-black"
              >
                Buscar
              </button>
            </section>
                  ...
                  <div key={event.id} className="border-4 border-white p-4 hover:translate-x-2 hover:-translate-y-2 transition-all bg-zinc-950 shadow-[8px_8px_0px_0px_rgba(234,179,8,1)] flex flex-col group/card">
                    ...
                    <div className="pt-6 flex gap-2">
                      ...
                      <button 
                        ...
                        className="bg-green-600 text-white p-2 flex items-center justify-center hover:bg-white hover:text-black transition-colors border-2 border-white shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]"
                        title="Compartir"
                      >
        ...
        <footer className="border-t-4 border-zinc-800 pt-8 pb-16 text-center">
          <p className="text-zinc-500 font-bold uppercase text-[10px] max-w-2xl mx-auto tracking-tighter leading-relaxed">
