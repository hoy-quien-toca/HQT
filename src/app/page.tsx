  ...
  return (
    <div className="min-h-screen text-white font-sans relative overflow-x-hidden">
      ...
      <header className="border-b-4 border-yellow-400 p-6 flex justify-between items-center bg-zinc-950 sticky top-0 z-50 shadow-xl">
        ...
        <nav className="hidden md:flex gap-6 font-bold uppercase tracking-widest text-sm text-right">
          ...
          <Link href="/submit" className="hover:text-yellow-400 bg-yellow-400 text-black px-4 py-1">Subir Fecha</Link>
        </nav>
      </header>
        ...
        {featuredEvents.length > 0 && (
          <section className="relative h-[450px] border-8 border-white bg-zinc-800 flex items-end p-10 overflow-hidden shadow-[12px_12px_0px_0px_rgba(234,179,8,1)] group">
            ...
            <div className="relative z-20 w-full text-left">
              ...
              <h2 className="text-6xl md:text-8xl font-black uppercase italic leading-[0.8] tracking-tighter mt-4 drop-shadow-2xl text-yellow-400">
                {featuredEvents[currentHeroIndex].band_name}
              </h2>
              <p className="text-2xl font-bold text-white uppercase tracking-widest border-l-8 border-red-600 pl-4 mt-4">
            ...
            <div className="relative w-full max-w-4xl bg-zinc-900 border-8 border-white shadow-[20px_20px_0px_0px_rgba(234,179,8,1)] flex flex-col md:flex-row overflow-y-auto max-h-[90vh]">
              ...
              <div className="md:w-1/2 p-8 space-y-6 text-left">
                ...
                <div className="pt-6 border-t-2 border-zinc-800 space-y-4">
                  <p className="text-3xl font-black italic text-yellow-400 tracking-tighter">
