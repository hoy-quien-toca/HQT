      ...
      <main className="max-w-4xl mx-auto p-4 md:p-6 py-16 relative z-10 font-black">
        ...
        <article className="space-y-8">
          <div className="space-y-4 text-center">
            ...
            <h1 className="text-4xl md:text-7xl font-franklin tracking-tighter text-white leading-none">
              {interview.title}
            </h1>
            
            {interview.subtitle && (
              <p className="text-xl md:text-3xl text-zinc-400 font-bold uppercase tracking-tight max-w-2xl mx-auto italic mt-4">
                {interview.subtitle}
              </p>
            )}
          ...
          <div className="prose prose-invert max-w-none text-xl md:text-2xl leading-relaxed font-bold space-y-6 text-zinc-200 uppercase tracking-tight pt-8">
